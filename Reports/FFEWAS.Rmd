...
limma.out.dir<-file.path(data.dir, 'CreatedData', 'limmaModels')
...
AllModelsdf<-AllModels %>% bind_rows(.id='ModelType')%>%mutate('Model'=gsub('.*_', '', ModelType), 'Age'=gsub('_.*', '', ModelType))
