...
```{r plot heatmap, fig.width=20, fig.height=12}
...
map(.x=pd.ancestry$pd, .f=~(bring.the.heatmap.sv(as.data.frame(.x), covar=c('smkPreg_binary', 'Sample_Plate', 'Slide', 'Array', 'ChildAgeComposite', 'cm1bsex', 'Epi', 'Fib', 'IC', 'cm1inpov', 'm1g2_YesNoPreg', 'm1g3_YesNoPreg', 'PostnatalMaternalSmokingAny', 'SmkAtVisitPastmonth'))))
```
