...
if(childdata %>% filter((childteen=='C' & k5f1l=='2 no') | (childteen=='T' & k6d40=='2 No' & k5f1l!='1 yes'))%>%nrow()!=nrow(modeldata)){stop('filter N and completecase data set N do not match')}
